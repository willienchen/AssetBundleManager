...
namespace AssetBundles {
    ...
    public class AssetBundleLoadAssetOperation : AssetBundleLoadAssetBaseOperation {
        ...
        public AssetBundleLoadAssetOperation(string bundle, string assetName, System.Type type, AssetBundleManager manager) {
